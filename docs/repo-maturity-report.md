...
Observed at **2026-09-13T12:15:55.240Z**. This generated section must be refreshed within 14 days from the machine-readable snapshot in [`docs/governance/repository-evidence.json`](governance/repository-evidence.json).
...
| ------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | --------------------------------- | ----------------------------------------------------------------------------------- |
| Private vulnerability reporting | enabled                                                                                                                                                                                                                             | @oaslananka | 2026-08-10; refresh every 90 days | GitHub REST API: private-vulnerability-reporting                                    |
| Security analysis features      | secret scanning enabled; push protection enabled; Dependabot security updates disabled                                                                                                                                              | @oaslananka | 2026-08-10; refresh every 90 days | GitHub REST API: GET /repos/oaslananka/a2amesh                                      |
| main branch protection          | 15 required status checks; strict updates enabled; 0 required approvals; stale-review dismissal enabled; code-owner review disabled; last-push approval disabled; admin enforcement enabled; force pushes blocked; deletion blocked | @oaslananka | 2026-08-10; refresh every 90 days | GitHub REST API: branch protection                                                  |
| npm-publish environment         | branches main; reviewers oaslananka; self-review allowed; 0 static environment secrets; OIDC trusted publishing                                                                                                                     | @oaslananka | 2026-08-10; refresh every 90 days | GitHub REST API: environments/npm-publish, branch policies, and environment secrets |
