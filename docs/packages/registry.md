...
See [ADR-0013: Agent Card Trust Log](../architecture/adr/0013-agent-card-trust-log.md) and [ADR-0014: SQLite Persistence for Trust Log and Fleet Storage](../architecture/adr/0014-sqlite-persistence-for-trust-log-and-fleet-storage.md) for the design rationale.
