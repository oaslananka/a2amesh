...
- Experimental OpenAI-compatible API and policy-backed official CLI workers are implemented. MCP, GitHub Action, webhook, and service-account cloud workers remain planned.
