...
Current status: the repository is still recruiting an independent maintainer before enabling mandatory multi-person review and full continuity. This condition is reviewed through the quarterly access and ruleset review recorded in the governance evidence. Until it is complete, continuity is documented as an explicit governance gap rather than being overstated.
