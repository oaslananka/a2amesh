...
- An unattended merge/publish/secret-access/destructive-terminal-execution system. Every
  ...
  Boundaries](/fleet/policy-sandbox-artifacts)).
...
The [`examples/mcp-bridge`](https://github.com/oaslananka/a2amesh/tree/main/examples/mcp-bridge) smoke path keeps the existing A2A/MCP mapping proof and adds a network-free Fleet worker lifecycle using an injected fake client.
