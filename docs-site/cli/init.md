...
Creates a new A2A Mesh agent project from the stable runtime or production-demo template, with
optional auth, rate limiting, and Dockerfile output.

Options:
  --adapter <adapter>    Template type (custom or production-demo) (default: "custom")
  --template <template>  Template type (custom or production-demo) (default: "custom")
...
### Initialize a credential-free production demo project. (Linux/macOS)

```bash
a2amesh init my-demo --template production-demo
```

### Initialize a credential-free production demo project. (PowerShell)
